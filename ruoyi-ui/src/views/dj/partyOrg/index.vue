  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="90%" append-to-body
      ...
      <el-form ref="form" :model="form" :rules="rules" :style="bodyStyle" label-width="150px">
        ...
        <party-org-post ref="partyOrgPost" :disabled="disabled"  :partyOrgUuid="form.partyOrgUuid"/>
...
<script>
  import {listPartyOrg, getPartyOrg, delPartyOrg, addPartyOrg,
    updatePartyOrg, exportPartyOrg,partyOrgTreeselect} from "@/api/dj/partyOrg";
