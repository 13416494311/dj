        ...
        <el-row :gutter="10" class="mb8">
          ...
          <!--<el-col :span="1.5">
            <el-button
              ...
              size="mini"
              @click="handleExport"
              v-hasPermi="['dj:partyMember:export']"
            >导出
            </el-button>
          </el-col>-->
        </el-row>
          ...
          <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
            <template slot-scope="scope">
              ...
              <el-button
                ...
                v-hasPermi="['dj:partyMember:edit']"
              >修改
              </el-button>
              <el-button
                size="small"
                ...
                v-hasPermi="['dj:partyMember:remove']"
              >删除
              </el-button>
            </template>
          </el-table-column>
...
<script>
  ...
  } from "@/api/dj/partyMember";
  import { postOptionSelect } from "@/api/system/post";
  import { partyOrgTreeselect, getPartyOrg } from "@/api/dj/partyOrg";
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete(row) {
        ...
        this.$confirm('是否确认删除党员信息编号为"' + memberIds + '"的数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function () {
          return delPartyMember(memberIds);
        }).then(() => {
          this.getList();
