...
<script>
  ...
  import activitySummary from "../../activity/detailed/activitySummary";
  import activityResolution from "../../activity/detailed/activityResolution";
  import activitySuggestions from "../../activity/detailed/activitySuggestions";
  import activityExperience from "../../activity/detailed/activityExperience";
  ...
  export default {
    ...
    methods: {
      ...
      handleSee() {
        this.reset();
        this.disabled = true;
        getDetailedByUuid(this.detailedUuid).then(response => {
