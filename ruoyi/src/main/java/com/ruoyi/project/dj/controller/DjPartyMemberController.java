...
public class DjPartyMemberController extends BaseController
{
     ...
     * 查询党员信息列表
     */
    @PreAuthorize("@ss.hasPermi('dj:partyMember:list')")
    @GetMapping("/list")
     ...
     * 导出党员信息列表
     */
    @PreAuthorize("@ss.hasPermi('dj:partyMember:export')")
     ...
     * 获取党员信息详细信息
     */
    @PreAuthorize("@ss.hasPermi('dj:partyMember:query')")
     ...
     * 新增党员信息
     */
    @PreAuthorize("@ss.hasPermi('dj:partyMember:add')")
     ...
     * 修改党员信息
     */
    @PreAuthorize("@ss.hasPermi('dj:partyMember:edit')")
     ...
     * 删除党员信息
     */
    @PreAuthorize("@ss.hasPermi('dj:partyMember:remove')")
