...
import com.ruoyi.project.dj.domain.DjPartyOrgPost;
import com.ruoyi.project.dj.service.IDjPartyOrgPostService;
 ...
 */
@RestController
@RequestMapping("/dj/partyOrgPost")
public class DjPartyOrgPostController extends BaseController
{
     ...
     * 查询党组织职务列表
     */
    @PreAuthorize("@ss.hasPermi('dj:partyOrgPost:list')")
    @GetMapping("/list")
     ...
     * 导出党组织职务列表
     */
    @PreAuthorize("@ss.hasPermi('dj:partyOrgPost:export')")
     ...
     * 获取党组织职务详细信息
     */
    @PreAuthorize("@ss.hasPermi('dj:partyOrgPost:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增党组织职务
     */
    @PreAuthorize("@ss.hasPermi('dj:partyOrgPost:add')")
     ...
     * 修改党组织职务
     */
    @PreAuthorize("@ss.hasPermi('dj:partyOrgPost:edit')")
     ...
     * 删除党组织职务
     */
    @PreAuthorize("@ss.hasPermi('dj:partyOrgPost:remove')")
